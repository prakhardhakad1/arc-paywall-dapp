...
import { X, Code2, Copy, Check, ExternalLink, ShieldCheck, Eye, Sparkles } from 'lucide-react';
      ...
      <div className="glass-panel w-full max-w-2xl max-h-[92vh] overflow-y-auto rounded-3xl p-6 sm:p-8 border border-slate-700/80 shadow-2xl relative">
        ...
        <div>
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-r from-slate-900/90 to-slate-950/90 border border-cyan-500/30 shadow-inner flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              onClick={() => alert('Embed preview test: on real sites, this triggers 1-click Arc USDC payment!')}
              className="w-full sm:w-auto px-5 py-2.5 rounded-xl text-xs font-bold bg-gradient-to-r from-cyan-600 to-blue-600 text-white shadow-md shadow-cyan-600/20 whitespace-nowrap"
            >
